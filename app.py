...
app = dash.Dash(name='__name__', external_stylesheets=[theme, css])
server = app.server
...
layout_part1 = html.Div([
    dbc.Row([
        html.Div('Comparing all-time daily average temperatures to a selected year',
                 style={'font-weight': 'bold', 'font-size': '30px'}),
        html.Br(), html.Br(), html.Br(), html.Br(),
        dbc.Col(children=[
            html.Br(),
            html.Div('Select a year', style={'font-weight': 'bold', 'font-size': '16px'}),
            year_input,
...
layout_part2_row1 = html.Div([
    html.Div('Examining Single Dates in History',
             style={'font-weight': 'bold', 'font-size': '30px'}),
    html.Br(), html.Br(),
    dbc.Row([
        dbc.Col(children=[
            html.Br(),
            html.Div('Select a month', style={'font-weight': 'bold', 'font-size': '16px'}),
            month_input,
            html.Br(),
            html.Div('Select a day', style={'font-weight': 'bold', 'font-size': '16px'}),
            day_input,
            html.Br(), html.Br(),
            html.Div('Select a temperature', style={'font-weight': 'bold', 'font-size': '16px'}),
            temp_input,
            html.Div('(degrees Celsius)', style={'font-size': '10px'}),
            html.Br(), html.Br()],
            ...
            html.Div(id='day-perc-geq',
                     children=[html.P(f'← \n'),  # , style={'font-size': '24px', 'align': 'center'}),
                               html.P(f'{start_day_perc_geq}% of days on record with the date of'
                                      f'{long_months[0]} {1} had a mean temperature at least as high'
                                      f'as {0} degrees Celius.')],
...
layout_part3 = html.Div([
    html.Div('Comparing Multiple Years to All-Time Average',
             style={'font-weight': 'bold', 'font-size': '30px'}),
    html.Br(), html.Br(),
    dbc.Row(children=[
        dbc.Col(children=[
    ...
    #     dbc.Col(children=[
    #         month_span_input],
    #         width={'offset': 3, 'size': 7})#, align='right')
    # ]),
    html.Br(), html.Br(), html.Br()])
...
def update_part2(month, day, temp):
    ...
    day_perc_geq = [html.P(f'← \n'),
                    html.P(f'{hadcet.get_perc_geq(short_months.index(month) + 1, day, temp)}% of days on '
                           ...
                           f' had a mean temperature at least as high as {temp}')]
    day_perc_geq[1].children += ' degree Celsius.' if temp in [1, -1] else ' degrees Celsius.'
